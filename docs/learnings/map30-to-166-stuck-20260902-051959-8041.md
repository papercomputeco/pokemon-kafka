# Expedition stuck: map 30 (6, 0) -> goal 166

run_id: 20260902-051959-8041  •  goal: reach map 166
...
```
GOAL: reach map 166. You are on map 30 at (6, 0).
...
PARTY: [('Gyarados', 20, 73), ('Dugtrio', 100, 259), ('Primeape', 99, 300), ('Pidgeot', 99, 347), ('Hypno', 99, 341), ('Charizard', 100, 341)]   BADGES byte: 0b00111111
...
- BACK_OUT_AND_REENTER on map 30 at (6, 0)
