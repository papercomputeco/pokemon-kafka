# Expedition stuck: map 30 (4, 8) -> goal 8

run_id: aeb90886d873  •  goal: reach map 8
...
```
GOAL: reach map 8. You are on map 30 at (4, 8).
...
PARTY: [('Charizard', 100, 341), ('Dugtrio', 100, 247), ('Primeape', 99, 300), ('Pidgeot', 99, 347), ('Hypno', 99, 341), ('Gyarados', 20, 73)]   BADGES byte: 0b00111111
...
- BACK_OUT_AND_REENTER on map 30 at (13, 8)
