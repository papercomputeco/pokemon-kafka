...
| artefact | where | what |
|---|---|---|
| corpus | [bdougie/pokemon-red-sft](https://huggingface.co/datasets/bdougie/pokemon-red-sft) (HF dataset) | 28,003 rows in nine domains, every row measured from a run on the cartridge; `sft_v6u` |
| Forger adapter | [bdougie/smollm3-pokemon-forger-lora](https://huggingface.co/bdougie/smollm3-pokemon-forger-lora) | LoRA r32 on SmolLM3-3B on v6u; held-out body 0.25 -> 0.89, outcome 0.39 -> 0.63 vs a 0.54 majority, gate 8/10; on 29 maps it never saw: body 0.90, outcome 0.64, gate 16/18; Q4_K_M GGUF under `gguf/` |
